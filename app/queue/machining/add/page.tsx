...
export default function AddMachiningJobPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (file) {
        ...
        const filePath = `machining-jobs/${fileName}`
    ...
    if (error) {
      ...
      toast.success('Machining Job added successfully!')
      router.push('/')
      router.refresh()
    }
  }
  ...
  return (
    <div className="p-6 max-w-2xl mx-auto">
      <h1 className="text-3xl font-bold text-funky-yellow mb-8">Add Machining Job</h1>
      <Card className="p-8">
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="Machine type, tools needed, etc."
            />
          </div>
